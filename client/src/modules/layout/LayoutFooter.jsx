...
const LayoutFooter = () => {
  return (
    <footer className="w-full bg-primary text-white py-8 flex flex-col items-center">
      ...
      <div className="flex space-x-2 mb-10">
        <a
          href="https://wa.me/5493541613185?text=Hola.%20Me%20gustaría%20contactarme%20contigo"
          target="_blank"
          rel="noreferrer"
